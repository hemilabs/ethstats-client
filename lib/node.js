...
Node.prototype.startWeb3Connection = function()
{
	...
	web3 = new Web3();
	web3.setProvider(new web3.providers.HttpProvider(process.env.RPC_URL ||  'http://' + (process.env.RPC_HOST || 'localhost') + ':' + (process.env.RPC_PORT || '8545')));
...
Node.prototype.getInfo = function()
{
	...
	try {
		...
		// crashes if the getter of web3.version.ethereum is executed.
		// See: https://github.com/ethereum/go-ethereum/issues/22441#issuecomment-805134582
		if (!web3.version.node.includes('Geth')) {
